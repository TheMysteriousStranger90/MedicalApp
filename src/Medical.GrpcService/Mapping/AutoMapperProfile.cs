...
public class AutoMapperProfile : Profile
{
    public AutoMapperProfile()
    {
        ...
        CreateMap<DoctorDto, DoctorModel>()
            .ForMember(dest => dest.Education, opt => opt.MapFrom(src => src.Education ?? string.Empty))
            .ForMember(dest => dest.Experience, opt => opt.MapFrom(src => src.Experience ?? string.Empty))
            .ReverseMap();
